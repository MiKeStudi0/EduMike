...
class _InviteFriendsScreenState extends State<InviteFriendsScreen> {
  ...
  void share(var appName) async {
    ...
    if (appName == 'WhatsApp') {
      ...
      url =
          "https://twitter.com/intent/tweet?text=${Uri.encodeComponent('$subject\n\n$body')}";
    } else if (appName == 'LinkedIn') {
      url =
          "https://www.linkedin.com/shareArticle?mini=true&url=${Uri.encodeComponent(url)}&title=${Uri.encodeComponent(subject)}&summary=${Uri.encodeComponent(body)}";
    }
